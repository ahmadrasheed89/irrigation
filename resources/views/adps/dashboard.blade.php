    ...
    <div class="content">
        ...
        <div class="card mb-4">
            <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                <div>
                    <h5 class="mb-0 fw-bold">🏗️ ADPs Dashboard</h5>
                    <p class="mb-0 mt-1 opacity-75">Comprehensive overview of Annual Development Programs - Financial tracking and performance monitoring</p>
                </div>
                <div class="btn-group">
        ...
        <div class="card shadow-sm">
                        ...
                        <tbody>
                            @forelse($adps as $adp)
                                ...
                                <tr class="border-start border-primary border-3">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <div class="text-muted small">
                                                    {{ $adp->schemes_count ?? 0 }} scheme{{ ($adp->schemes_count ?? 0) != 1 ? 's' : '' }}
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="text-end">
                                        <span class="fw-bold text-success">Rs.{{ number_format($adp->schemes_sum_expenditure ?? 0, 0) }}</span>
                                    </td>
                                    <td class="text-end">
                                        <span class="fw-bold text-warning">Rs.{{ number_format($adp->schemes_sum_liability ?? 0, 0) }}</span>
                                    </td>
            ...
            <!-- Pagination - Only show if $adps is a paginator instance -->
            @if(method_exists($adps, 'links'))
            ...
            @else
                <!-- Show simple record count for collections -->
                <div class="card-footer bg-light">
                    <div class="text-muted small text-center">
                        Showing all {{ $adps->count() }} records
                    </div>
                </div>
            @endif
        </div>
